...
interface EventTarificationsFormProps {
  event: TEvent;
}

export function EventTarificationsForm({ event }: EventTarificationsFormProps) {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Types de billets disponibles pour "{event.description}"
        </p>
      </div>

      <div className="grid grid-cols-1 gap-6">
        {event.tarifications.map((ticket, index) => (
